...
save('referencia_datos', 't', 'referencia', 'uk', 'pos_medida', 'pos_obs', 'theta_medida', 'theta_obs', 'vel_angular_medida', 'vel_angular_obs', 'vel_medida', 'vel_obs'); %para volcar los datos en un archivo
